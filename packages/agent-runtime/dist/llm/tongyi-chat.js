...
export class TongyiChatModel extends BaseChatModel {
    static lc_name() {
    ...
    constructor(fields = {}) {
        ...
        this.lc_namespace = ['starlink', 'tongyi'];
        this.apiKey =
            fields.apiKey ??
                ...
                '';
        if (!this.apiKey) {
            throw new Error('TongyiChatModel requires DASHSCOPE_API_KEY (or TONGYI_API_KEY / QWEN_API_KEY) to be set');
        }
        this.model =
            fields.model ??
