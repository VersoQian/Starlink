...
export function resolveVisualizationModel() {
...
export async function runVisualizationAnalysis(input, llm = resolveVisualizationModel()) {
...
export function createVisualizationAnalysisTool(llm) {
    return new DynamicStructuredTool({
        name: 'generate_visualization_analysis',
        description: '根据数据摘要与业务目标规划可视化图表，并产出分析洞察。返回结构化 JSON，可用于前端渲染。',
        schema: z.object({
            datasetSummary: z
                .string()
                .min(10)
