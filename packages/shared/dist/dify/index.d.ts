...
export declare class DifyRequestError extends Error {
  ...
  constructor(status: number, statusText: string, detail?: string, requestId?: string)
}
...
export declare function readErrorDetail(response: Response): Promise<string | undefined>
